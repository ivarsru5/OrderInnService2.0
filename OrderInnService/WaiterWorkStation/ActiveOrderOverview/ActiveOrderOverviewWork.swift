...
class ActiveOrderOverviewWork: ObservableObject{
    ...
    func collectAllOrderParts(withExtras: [ExtraOrderOverview]){
        ...
        self.collectedOrder = ClientSubmittedOrder(id: submitedOrder.id,
                                                   placedBy: submitedOrder.placedBy,
                                                   orderOpened: submitedOrder.orderCompleted,
                                                   orderReady: submitedOrder.orderReady,
                                                   totalPrice: totalOrderPrice,
                                                   forTable: submitedOrder.forTable,
                                                   withItems: submitedOrder.withItems,
                                                   withExtraItems: withExtras)
    }
    ...
    func retreveSubmitedItems(from items: ActiveOrder){
        ...
        self.submitedOrder = OrderOverview(id: items.id, placedBy: items.placedBy, orderReady: items.orderReady, totalPrice: items.totalPrice, forTable: items.forTable, withItems: submitedItems)
